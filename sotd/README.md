...
Create an app in your [Spotify Developer Dashboard](https://developer.spotify.com/dashboard/), set the redirect URI to `http://127.0.0.1:5173/callback` and copy your Client ID. 
